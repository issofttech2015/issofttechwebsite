...
jQuery('head').append('<link rel="stylesheet" id="colors" href="assets/css/colors/preset.css" y />');
jQuery('head').append('<link rel="stylesheet" href="assets/css/color-switcher.css"  />');
